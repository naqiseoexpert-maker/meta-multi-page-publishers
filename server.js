...
async function ensureDatabaseSchema(db) {
  if (!db) {
    throw new Error(
      "D1 binding DB is missing. Check Cloudflare Worker Bindings."
    );
  }
...
<div class="container">
  ...
  <div class="top">
    ...
    <div>
      ...
      <div class="subtitle">
        Connect Facebook accounts and publish
        to multiple Pages.
      </div>
